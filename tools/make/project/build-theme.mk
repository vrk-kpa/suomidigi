...
ifeq ($(ENV),dev)
	$(call step,Do npm ci for theme in specific node docker container...\n)
	...
	$(call step,Build theme for ${BUILD_THEME_ARGS} in specific node docker container...\n)
	...
	$(call step,Do npm ci for theme on ${RUN_ON}...\n)
	$(call node_run,ci ${NPM_BUILD_FLAG} --prefix ${PATH_TO_THEME}/${DRUPAL_THEME_NAME} --engine-strict true)
	$(call step,Build theme for ${BUILD_THEME_ARGS} on ${RUN_ON}...\n)
	$(call node_run,run --prefix ${PATH_TO_THEME}/${DRUPAL_THEME_NAME} gulp ${BUILD_THEME_ARGS})
endif
