            ...
            if (config.showCharCount) {
                if (config.maxCharCount > -1) {
                    ...
                    defaultFormat += editor.lang.wordcount[config.countHTML ? "CharCountWithHTML" : "CharCount"] +
                        " %charCount%, " + editor.lang.wordcount.ReadTime + " %readTimeMinute% " + editor.lang.wordcount.ReadTimeMinute;
                }
            }
            ...
            function updateCounter(editorInstance) {
                ...
                if (text) {
                    if (config.showCharCount) {
                        ...
                        readTimeMinute = Math.round((charCount / 1400) * 2) / 2;
                    }
                ...
                if (config.showRemaining) {
                    ...
                    html = html.replace("%readTimeMinute%", readTimeMinute).replace("%wordCount%", wordCount).replace("%charCount%", charCount).replace("%paragraphsCount%", paragraphs);
                }
